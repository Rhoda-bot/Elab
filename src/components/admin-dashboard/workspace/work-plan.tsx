...
function AdWorkPlans() {
  ...
  const handleAddWorkspacePlan = () => {
    navigate('/admin_dashboard/workspaces/add-workspaces');
  };
  const handleEditWorkspacePlan = () => {
    navigate('/admin_dashboard/workspaces/edit-workspaces');
  };
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-6 text-lg-end text-center">
                <button type="button" className="impact--btn" onClick={handleAddWorkspacePlan}>Add a Plan</button>
              </div>
            </div>
            <div className="row">
