        ...
        <div className="row">
          <div className="row">
            <div className="col-md-6 text-lg-start text-center">
              <span className="impact--title"> Media Mention</span>
            </div>
            ...
            <div className="content__card w-100 p-5">
              <form className="content__form mx-5">
                ...
                <div className="py-2">
                  ...
                  <br />
                  <input type="date" className="p-3 my-2 content__form--input form-control" id="name" name="date" onChange={handleOnChange} value={date} required />
                </div>
                <div className="py-2">
